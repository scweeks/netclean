...
- Do not weaken security checks, analyzer rules, test assertions, the 71% overall coverage ratchet, or the 95% changed-file target to make CI pass. Raise the overall ratchet as tests move the project toward 95% total coverage.
